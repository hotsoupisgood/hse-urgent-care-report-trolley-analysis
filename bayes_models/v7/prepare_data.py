"""
Prepare V7 response variable: trolleys per million budget .

Scaling: total_trolleys / (regional_budget / 1000)

Input:
  - data/raw data/weekly_by_region_202604082051.csv  (raw weekly region-level trolley counts)
  - data/2026_hr_budget.xlsx                         (HSE regional budgets, single row, regions as columns)
...
df['scaled'] = df['total_trolleys'] / (df['Budget'] / 1000)
