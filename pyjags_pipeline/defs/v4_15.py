...
class Model(BaseModel):
    ...
    @property
    def name(self):
        return ('Baseline + Annual Cycle (region-specific amplitude, global phase)'
                ' + Regional New Year (date-anchored)'
                ' + MW Reset (3 weeks + 2 post) + AR(2)')
    ...
    def monitor_params(self):
        return ['alpha', 'amp', 'phase', 'tau', 'phi1', 'phi2',
