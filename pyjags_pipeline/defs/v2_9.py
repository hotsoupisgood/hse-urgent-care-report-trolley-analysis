...
class Model(BaseModel):
    ...
    @property
    def name(self):
        return ('Baseline + AR(1) + Annual Cycle + Regional New Year '
                '(date-anchored: Mon-week containing Dec 11 / Dec 18 / Dec 25 / Jan 1 / Jan 8) '
    ...
    def monitor_params(self):
        return ['alpha', 'beta', 'gamma', 'tau', 'phi',
                'delta_pm2', 'delta_pm1', 'delta_pre', 'delta_mid', 'delta_post',
    ...
    def jags_data(self, y, n_region, n_weeks, regions):
        ...
        return dict(
            ...
            ny_pm2=ny['ny_pm2'], ny_pm1=ny['ny_pm1'],
