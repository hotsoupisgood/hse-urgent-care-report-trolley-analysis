...
from model_tab import model_page
...
APP_TITLE = "Emergency Department Dashboard"
    ...
    return html.Div(style={"maxWidth": PAGE_WIDTH, "margin": "0 auto"}, children=[
        html.Div(style=CARD, children=[
            ...
            html.P([
                ...
                html.A("daily TrolleyGAR report",
                       href="https://uec.hse.ie/uec/TGAR.php",
                       target="_blank", style=link),
                ", which publishes on-trolley figures each morning for all "
...
app.layout = html.Div(
    ...
    children=[
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        for label, val in [("Findings", "model"), ("Map", "map"), ("Trends", "trends"), ("About", "about")]
                    ],
                ),
            ],
        ),
        ...
        html.Div(style={"display": "none"}, children=[
            dcc.Tabs(id="nav-tabs", value="model", children=[
                dcc.Tab(label="Findings", value="model"),
...
app.clientside_callback(
    """
    function(activeTab) {
        const tabs = ['model', 'map', 'trends', 'about'];
        const styles = [];
        for (const t of tabs) {
            if (t === activeTab) {
...
app.clientside_callback(
    ...
    function(_) {
        ...
        return [params.get('tab') || 'model', data];
    }
    """,
...
def update_map(selected_date, metric_key, per10k_toggle, level):
    ...
    fig = px.choropleth_map(
        ...
        color=color_col,
        color_continuous_scale=["#f7fcf5", "#005a32"],  # thesis green gradient
