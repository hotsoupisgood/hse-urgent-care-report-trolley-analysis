...
kableExtra::kbl(
  ...
  caption   = "DIC comparison across the models (trolley count scaled by 2026 regional budget)."
) |>
...
kableExtra::kbl(
  ...
  row.names = FALSE,
  col.names = c("Model", "Description", "Deviance", "pD", "DIC"),
  caption   = "DIC comparison across models (response scaled by June 2025 health region inpatient bed count)."
) |>
  kableExtra::kable_styling(latex_options = "hold_position")
```
