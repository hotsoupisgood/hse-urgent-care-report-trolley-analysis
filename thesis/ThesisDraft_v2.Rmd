...
In this chapter we describe how we extracted, transformed and explored the trolley counts. Data was sourced from the HSE emergency trolley report, aggregated from days to weeks, hospitals to regions, then standardised to investigate several hypothesis. Finally exploring the standardised data to influence our models.


## Data Collection  \label{sect:data-pipeline}
...
After collection, the on trolley counts are scaled to three different rates to understand their impact on ranks between regions. Informed by EDA, the models were specified.
...
```{r gelman-v2-1, results='asis'}
gelman <- read.csv(
  "../data/models/wide_weekly_scaledPer10k/v2.1/gelman.csv",
...
kableExtra::kbl(
  ...
  digits    = 4,
  row.names = FALSE,
  col.names = c("Parameter", "Point est.", "Upper C.I."),
  caption   = "Gelman-Rubin $\\hat{R}$ for all monitored scalar parameters of model v2.1."
) |>
